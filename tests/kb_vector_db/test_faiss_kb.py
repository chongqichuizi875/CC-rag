import sys
# print(sys.path)
sys.path.append('/home/cc007/cc/Langchain-Chatchat')
...
import json
with open("/home/cc007/cc/Langchain-Chatchat/tests/kb_vector_db/query.json", "r") as f:
    queries = json.load(f)
...
with open("/home/cc007/cc/Langchain-Chatchat/tests/kb_vector_db/answer.json", "w", encoding='utf-8') as f:
